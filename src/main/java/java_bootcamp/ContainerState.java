...
public class ContainerState implements ContractState {
    ...
    public static void main(String[] args) {
        ...
        ContainerState container = new ContainerState(2, 4, 3, "Jetpacks", jetpackImporters, jetpackCarriers);
    }
    ...
    public List<AbstractParty> getParticipants() {
        return ImmutableList.of(owner, carrier); //participants who get notified
    }
}
